/** Подсказки для пула антидостижений — мастер задаёт при создании кампании. */
...
export const stubCampaignAssets: Record<string, CampaignAsset[]> = {
  '1': [
    {
      id: 'a1',
      title: 'Карта Баровии',
...
export const stubCampaignChat: Record<string, CampaignChatMessage[]> = {
  '1': [
    ...
    { id: 'c3', author: 'Игорь', text: 'Торвин принесит эль для всех', time: '12:20' },
  ],
  '2': [
...
export function getCampaignAssets(campaignId: string): CampaignAsset[] {
  return stubCampaignAssets[campaignId] ?? []
}

export function getCampaignChat(campaignId: string): CampaignChatMessage[] {
  return stubCampaignChat[campaignId] ?? []
}
